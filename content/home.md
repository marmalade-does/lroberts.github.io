<!-- Remember if you want to add more you need to go to the index.html and add `<li><a href="#" data-page="home">Blog</a></li>` -->
Hi, I'm Lukas!

Right now my focus is university. I do a double bachelor in genetics and informatics and in my spare time I read, binge [MIT OCW](https://ocw.mit.edu) and not much else.
...
(In the future) check out my [Blog](#blog) when I eventually start uploading what I write ... -->
...
I declare [crockers rules](http://sl4.org/crocker.html)
